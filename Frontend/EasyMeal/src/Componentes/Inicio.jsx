...
const Inicio = () => {
    return (
        <>
            ...
            <p className="max-w-xl text-sm mb-8 text-center">
            ...
            <img src="/images/index/queso.png" alt="queso" className="absolute top-30 left-16 w-10" />
            <img src="/images/index/aguacate.png" alt="palta" className="absolute top-30 right-16 w-10" />
            ...
            <img src="/images/index/carne.png" alt="carne" className="absolute top-70 left-24 w-10" />
            <img src="/images/index/index.png" alt="persona" className="w-40 mb-6" />

            <button className="bg-sage text-white px-6 py-2 rounded-md mb-4 hover:bg-sage transition">Iniciar sesión</button>

            <div >
                <img src="/images/index/fondo_texto.png" alt="fondoTextoRegistro" className=""/>
                <p >

    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-white px-6 sm:px-12 md:px-20 py-8">
      <div className="bg-white border border-black rounded-2xl py-10 px-6 sm:px-12 w-full max-w-2xl space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Link
            to="/registrar"
            className="w-40 sm:w-50 mx-auto block text-base sm:text-xl bg-sage text-white text-center font-semibold py-2 rounded-xl hover:bg-mint hover:scale-105 transform transition duration-300"
          >
            Registrarse
          </Link>
        </form>
